		...
		<div className="space-y-8">
			<div className="flex justify-between items-center">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						Manage your portfolio artifacts
					</p>
				</div>
				<Dialog
					open={isOpen}
				...
				>
					...
					<DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-surface border-border">
						<DialogHeader>
							...
							<DialogDescription>
								Provide details about your project to showcase in your
								portfolio.
							</DialogDescription>
						</DialogHeader>
			...
			<div className="grid grid-cols-1 gap-5">
				{projects.map((project) => (
					<CodeCard
						key={project.id}
						title={project.title.toLowerCase().replace(/\s/g, "-") + ".md"}
										...
										<AlertDialog>
											...
											<AlertDialogContent className="bg-surface border-border">
												<AlertDialogHeader>
													...
													<AlertDialogDescription>
														This will permanently delete the project artifact
														from your system.
													</AlertDialogDescription>
												</AlertDialogHeader>
												<AlertDialogFooter>
