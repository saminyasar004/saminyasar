				...
				<div className="max-w-full mx-auto space-y-12">
					<div className="text-center space-y-4 animate-fade-in">
						...
						<p className="text-muted-foreground text-lg">
							Passionate developer with a love for building
					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						...
						<div className="space-y-6 animate-fade-in-up">
							<p className="text-lg leading-relaxed text-foreground/90">
								I'm a Full Stack JavaScript Developer who
								started coding in 2020. What began as curiosity
								quickly turned into a passion for creating
								elegant and efficient web applications.
							</p>
							<p className="text-lg leading-relaxed text-foreground/90">
								I specialize in building modern, responsive, and
								performant applications using cutting-edge
								technologies. From frontend to backend,
								databases to deployment, I enjoy every aspect of
						...
						>
							<div className="relative max-w-md mx-auto">
								...
								<div className="relative">
									...
									{/* Photo container */}
									<div className="relative glass-strong rounded-[1.5rem] p-2 overflow-hidden">
										<img
											src={globalSettings.photoUrl}
											alt="Samin Yasar"
											className="w-full aspect-square object-cover rounded-[1.3rem] transition-transform hover:scale-105 duration-500"
										/>
