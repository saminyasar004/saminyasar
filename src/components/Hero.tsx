      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="flex flex-wrap items-center gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <Button
                ...
                size="lg"
                className="glass-strong bg-accent hover:bg-accent/90 text-accent-foreground rounded-full px-8 shadow-lg hover:shadow-accent/50 transition-all hover:scale-105"
              >
                Get In Touch
              </Button>
              <Button
                variant="outline"
                size="lg"
                className="glass rounded-full px-8 border-accent text-accent hover:bg-accent hover:text-accent-foreground transition-all hover:scale-105"
                asChild
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="glass rounded-full px-8 border-accent/50 hover:border-accent hover:bg-accent/10 transition-all hover:scale-105"
                asChild
              >
                <a href={globalSettings.resumeUrl} target="_blank" rel="noopener noreferrer">
            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="glass-strong rounded-3xl p-8 h-full flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-4">
                  <div className="text-6xl font-bold text-accent animate-glow">4+</div>
                ...
                <div className="absolute bottom-10 left-10 glass rounded-lg px-4 py-2 text-xs text-accent font-mono animate-float" style={{ animationDelay: "0.5s" }}>
                  {'{...}'}
                </div>
              </div>
            </div>
