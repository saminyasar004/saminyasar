  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-full mx-auto">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            >
              ...
              Passionate about building scalable applications and turning ideas
              into reality.
            </p>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer" onClick={scrollToContact}>
